...
export function ApiProxyPanel({
  ...
  return (
    <section className="proxyPage">
      ...
      <section className="remoteSection">
        <div className="remoteSectionHeader">
          <div>
            <p className="proxyKicker">{proxyCopy.remoteKicker}</p>
            <h3>{proxyCopy.remoteTitle}</h3>
            <p className="cloudflaredBody">{proxyCopy.remoteDescription}</p>
          </div>
                ...
                <article className="remoteServerCard" key={draft.id}>
                  <div className="remoteServerGrid">
                    <label className="remoteServerField">
                      ...
                      <input
                        value={draft.label}
                        onChange={(event) => updateRemoteDraft(draft.id, "label", event.target.value)}
                    ...
                    <label className="remoteServerField">
                      ...
                      <input
                        value={draft.host}
                        onChange={(event) => updateRemoteDraft(draft.id, "host", event.target.value)}
                        placeholder="1.2.3.4"
                      />
                    </label>
                    <label className="remoteServerField">
                      ...
                      <input
                        inputMode="numeric"
                        value={draft.sshPort}
                        onChange={(event) => updateRemoteDraft(draft.id, "sshPort", event.target.value)}
                    ...
                    <label className="remoteServerField">
                      ...
                      <input
                        value={draft.sshUser}
                        onChange={(event) => updateRemoteDraft(draft.id, "sshUser", event.target.value)}
                        placeholder="root"
                      />
                    </label>
                    <label className="remoteServerField">
                      ...
                      <input
                        ...
                        onChange={(event) => updateRemoteDraft(draft.id, "remoteDir", event.target.value)}
                      ...
                      {draft.authMode === "keyContent" ? (
                        <label className="remoteServerField">
                          ...
                          <textarea
                            ...
                            onChange={(event) => updateRemoteDraft(draft.id, "privateKey", event.target.value)}
                      ...
                      {draft.authMode === "password" ? (
                        <label className="remoteServerField">
                          ...
                          <input
                            ...
                            onChange={(event) => updateRemoteDraft(draft.id, "password", event.target.value)}
                  ...
                  <div className="remoteServerActions">
                    ...
                    <button className="ghost" onClick={() => removeRemoteDraft(draft.id)} disabled={remoteBusy}>
                      {proxyCopy.remoteRemove}
                    </button>
                    <button className="primary" onClick={() => onDeployRemote(remoteConfig)} disabled={remoteBusy}>
                      {deployingRemote ? proxyCopy.remoteDeploying : proxyCopy.remoteDeploy}
                    </button>
                    <button className="ghost" onClick={() => onRefreshRemoteStatus(remoteConfig)} disabled={remoteBusy}>
                      {refreshingRemote ? proxyCopy.remoteRefreshing : proxyCopy.remoteRefresh}
                    </button>
                    {remoteStatus?.running ? (
                      <button className="danger" onClick={() => onStopRemote(remoteConfig)} disabled={remoteBusy}>
                        {stoppingRemote ? proxyCopy.remoteStopping : proxyCopy.remoteStop}
                      </button>
                    ) : (
                      <button className="primary" onClick={() => onStartRemote(remoteConfig)} disabled={remoteBusy}>
                  ...
                  <article className="proxyDetailCard remoteLogCard">
                    <div className="proxyDetailHeader">
                      ...
                      <button className="ghost proxyCopyButton" onClick={() => copyText(remoteLog ?? null)} disabled={!remoteLog}>
                        {proxyCopy.copy}
                      </button>
                    </div>
